...
INSERT INTO `meta_company` (`s_no`, `company_name`, `company_info`, `message`, `date`, `day`, `year`, `placement_info`, `start_date`, `end_date`, `enddate`, `endmonth`, `endyear`) VALUES
(1, 'Jindal Steels', 'Meta company', 'Date of Arrival: 14th August 2014', 14, 8, 2014, '', '14-8-2014', '', 0, 0, 0),
(1, 'Jindal Steels', 'Meta company', 'Date of Arrival: 14th August 2014', 14, 8, 2014, '', '14-8-2014', '', 0, 0, 0);
