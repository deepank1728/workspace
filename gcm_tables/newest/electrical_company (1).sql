...
INSERT INTO `electrical_company` (`s_no`, `company_name`, `company_info`, `message`, `date`, `day`, `year`, `placement_info`, `start_date`, `end_date`, `enddate`, `endmonth`, `endyear`) VALUES
(1, 'L&T Technology', 'electrical company', 'Date of Arrival:12th August 2014', 12, 8, 2014, '', '12-8-2014', '', 0, 0, 0);
