...
public class EventsTab2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expListView.setOnChildClickListener(new OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                Database_functions info1=new Database_functions(EventsTab2Activity.this);
    	        info1.open();
                ...
                Intent i = new Intent(EventsTab2Activity.this,Event_details.class);
                i.putExtras(b);
       	     startActivity(i);
    ...
    private void setDataChild(int j,String table)
    {
	       ...
	       Database_functions info22=new Database_functions(EventsTab2Activity.this);
	         info22.open();
